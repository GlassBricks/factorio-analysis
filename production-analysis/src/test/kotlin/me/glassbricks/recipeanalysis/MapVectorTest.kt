...
class MapVectorTest : StringSpec({
    "should remove 0 values on construction" {
        val mapVector = amountVector("a" to 1.0, "b" to 0.0, "c" to 2.0)
        mapVector shouldBe amountVector("a" to 1.0, "c" to 2.0)
    }
    "get" {
    ...
    "plus" {
        val mapVector1 = amountVector("a" to 1.0, "b" to 2.0, "z" to 3.0)
        val mapVector2 = amountVector("b" to 3.0, "c" to 4.0, "z" to -3.0)
        val result = mapVector1 + mapVector2
        result shouldBe amountVector("a" to 1.0, "b" to 5.0, "c" to 4.0)
    }
    "minus" {
        val mapVector1 = amountVector("a" to 1.0, "b" to 2.0, "z" to 3.0)
        val mapVector2 = amountVector("b" to 3.0, "c" to 4.0, "z" to 3.0)
        val result = mapVector1 - mapVector2
        result shouldBe amountVector("a" to 1.0, "b" to -1.0, "c" to -4.0)
    }
    "unaryMinus" {
        val mapVector = amountVector("a" to 1.0, "b" to 2.0)
        val result = -mapVector
        result shouldBe amountVector("a" to -1.0, "b" to -2.0)
    }
    "times" {
        val mapVector = amountVector("a" to 1.0, "b" to 2.0)
        val result = mapVector * 2.0
        result shouldBe amountVector("a" to 2.0, "b" to 4.0)
    }
    "times 0" {
        val mapVector = amountVector("a" to 1.0, "b" to 2.0)
    ...
    "div" {
        val mapVector = amountVector("a" to 1.0, "b" to 2.0)
        val result = mapVector / 2.0
        result shouldBe amountVector("a" to 0.5, "b" to 1.0)
    }
    "div infinite" {
        val mapVector = amountVector("a" to 1.0, "b" to 2.0)
    ...
    "closeTo" {
        ...
        val b = amountVector("a" to 1.1, "b" to 2.1, "c" to 0.1)
