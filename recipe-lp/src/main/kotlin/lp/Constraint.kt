...
infix fun <T> Vector<out T>.leq(rhs: Vector<T>) = (this - rhs).leq(0.0)
infix fun <T> Vector<out T>.eq(rhs: Vector<T>) = (this - rhs).eq(0.0)
infix fun <T> Vector<out T>.geq(rhs: Vector<T>) = (this - rhs).geq(0.0)
